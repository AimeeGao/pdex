...
<template>
    <div class="flex items-center gap-4">
        ...
        <nav class="hidden md:flex items-center gap-2 bc-nav">
            ...
            <Link 
                href="/student" 
                :class="['bc-nav-link', { 'active': $page.url === '/student' }]"
            >
                Dashboard
            </Link>
            ...
            <template v-if="hasStudentRole">
                ...
                <Link 
                    ...
                    :class="['bc-nav-link', { 'active': $page.url.includes('/student/applications') }]"
                >
                    Applications
                </Link>
                <Link 
                    href="/student/documents" 
                    :class="['bc-nav-link', { 'active': $page.url.includes('/student/documents') }]"
                >
                    Documents
                </Link>
            </template>
        ...
        <div v-if="showingNavigationDropdown" class="absolute top-full left-0 right-0 bc-mobile-nav md:hidden">
            <!-- Student Dashboard -->
            <Link href="/student" class="bc-nav-link">Dashboard</Link>
            
            <!-- Student Links (only for student users) -->
            <template v-if="hasStudentRole">
                <Link href="/student/profile" class="bc-nav-link">Profile</Link>
                <Link href="/student/applications" class="bc-nav-link">Applications</Link>
                <Link href="/student/documents" class="bc-nav-link">Documents</Link>
            </template>
