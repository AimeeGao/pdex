      ...
      <div class="row">
        <div class="col-12">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h3 mb-0">Create My Profile</h1>
            <!-- <Link href="/student/profile/index" class="btn btn-outline-secondary">
